...
::   Install.cmd AllUsers "D:\Modules\sqmDataTransfer"  -> system-wide, custom path
...
if /i not "%SCOPE%"=="CurrentUser" (
    if "%IS_ADMIN%" neq "0" (
        echo.
        echo  sqmDataTransfer - Elevation erforderlich
        echo  ============================================================
...
:: ---------------------------------------------------------------
echo.
echo  sqmDataTransfer - Installation
echo  ============================================================
...
:: ---------------------------------------------------------------
set "BOOT_DIR=%TEMP%\sqmDataTransfer_boot"
