...
$script:sqmtStrings = @{
	de = @{
		...
		'Constraints.DisableTrgAction'       = "Trigger '{0}' auf '{1}' deaktivieren"
		'Constraints.TrgDisabled'            = "Trigger '{0}' auf '{1}' deaktiviert."
		'Constraints.TrgDisableFailed'       = "Trigger '{0}' auf '{1}' konnte nicht deaktiviert werden: {2}"
		'Constraints.NoActiveTriggers'       = "Keine aktiven Trigger auf '{0}' gefunden."
		'Constraints.TrgQueryFailed'         = "Fehler beim Ermitteln der Trigger auf '{0}': {1}"
		'Constraints.EnableTrgAction'        = "Trigger '{0}' auf '{1}' aktivieren"
		'Constraints.TrgEnabled'             = "Trigger '{0}' auf '{1}' aktiviert."
		'Constraints.TrgEnableFailed'        = "Trigger '{0}' auf '{1}' konnte nicht aktiviert werden: {2}"
		'Constraints.DisabledTrgQueryFailed' = "Fehler beim Ermitteln deaktivierter Trigger auf '{0}': {1}"
		...
		'Gui.ColRowCountDst'        = 'Zeilen (Ziel)'
		'Gui.ActionTransfer'        = '-> Transfer'
		'Gui.ActionCreate'          = '+ Anlegen'
		'Gui.ActionDone'            = 'Fertig'
		'Gui.ActionUnknown'         = '?'
		...
		'Gui.ToggleTriggers'        = 'Trigger ein-/ausschalten'
		...
		'Gui.ModeGroup'             = 'Transfermodus'
		'Gui.ModeAuto'              = 'Automatisch'
		'Gui.ModeNormal'            = 'Normal (eine Kopie je Tabelle)'
		'Gui.ModeChunk'             = 'Chunk-Transfer (wiederaufsetzbar)'
		'Gui.ModeAutoTip'           = 'Pro Tabelle entscheiden: Chunk-Transfer nur fuer sehr grosse Tabellen, deren Ziel bereits teilweise befuellt ist (dort zahlt sich die Wiederaufsetzbarkeit aus), sonst die schnellere normale Kopie.'
		'Gui.ModeNormalTip'         = 'Alle ausgewaehlten Tabellen als einzelne All-or-nothing-Kopie uebertragen.'
		'Gui.ModeChunkTip'          = 'Alle ausgewaehlten Tabellen chunk-weise uebertragen. Ein abgebrochener Lauf kann wiederholt werden und ueberspringt die bereits vollstaendigen Chunks.'
		'Gui.ChunkColumnLabel'      = 'Chunk-Spalte:'
		'Gui.ChunkColumnAuto'       = '(automatisch)'
		'Gui.ChunkColumnTip'        = 'Leer lassen fuer automatische Erkennung. Eine feste Spalte laesst sich nur angeben, wenn genau eine Tabelle ausgewaehlt ist - bei mehreren wird je Tabelle einzeln erkannt.'
		'Gui.DetectChunkColumn'     = 'Erkennen'
		'Gui.DetectRunning'         = 'Erkenne Chunk-Spalte...'
		'Gui.DetectResult'          = 'Chunk-Spalte fuer {0}: [{1}], {2} Chunk(s), ca. {3} Zeile(n) je Chunk (geschaetzt aus der Statistik, kein Scan).'
		'Gui.DetectNone'            = 'Fuer {0} wurde keine geeignete Chunk-Spalte gefunden: {1}'
		'Gui.DetectFailed'          = "Erkennung der Chunk-Spalte fehlgeschlagen:`n{0}"
		'Gui.DetectSelectOneTable'  = 'Bitte genau eine Tabelle auswaehlen, um die Chunk-Spalte zu erkennen.'
		'Gui.ChunkRunning'          = 'Chunk-Transfer laeuft: {0} ({1} von {2})...'
		'Gui.ChunkTableFailed'      = 'Chunk-Transfer fuer {0} fehlgeschlagen: {1}'
		'Gui.AutoModeDecision'      = 'Automatik: {0} Tabelle(n) chunk-weise, {1} Tabelle(n) normal.'
	...
	en = @{
		...
		'Constraints.DisableTrgAction'       = "Disabling trigger '{0}' on '{1}'"
		'Constraints.TrgDisabled'            = "Trigger '{0}' on '{1}' disabled."
		'Constraints.TrgDisableFailed'       = "Trigger '{0}' on '{1}' could not be disabled: {2}"
		'Constraints.NoActiveTriggers'       = "No active triggers found on '{0}'."
		'Constraints.TrgQueryFailed'         = "Error retrieving triggers on '{0}': {1}"
		'Constraints.EnableTrgAction'        = "Enabling trigger '{0}' on '{1}'"
		'Constraints.TrgEnabled'             = "Trigger '{0}' on '{1}' enabled."
		'Constraints.TrgEnableFailed'        = "Trigger '{0}' on '{1}' could not be enabled: {2}"
		'Constraints.DisabledTrgQueryFailed' = "Error retrieving disabled triggers on '{0}': {1}"
		...
		'Gui.ColRowCountDst'        = 'Rows (destination)'
		'Gui.ActionTransfer'        = '-> Transfer'
		...
		'Gui.ToggleTriggers'        = 'Enable/disable triggers'
		...
		'Gui.Cancel'                    = 'Cancel'
		'Gui.ModeGroup'             = 'Transfer mode'
		'Gui.ModeAuto'              = 'Automatic'
		'Gui.ModeNormal'            = 'Plain (one copy per table)'
		'Gui.ModeChunk'             = 'Chunked (resumable)'
		'Gui.ModeAutoTip'           = 'Decide per table: chunked only for very large tables whose destination is already partly filled (where resumability pays off), otherwise the faster plain copy.'
		'Gui.ModeNormalTip'         = 'Transfer every selected table as a single all-or-nothing copy.'
		'Gui.ModeChunkTip'          = 'Transfer every selected table chunk by chunk. An interrupted run can simply be repeated and skips the chunks that are already complete.'
		'Gui.ChunkColumnLabel'      = 'Chunk column:'
		'Gui.ChunkColumnAuto'       = '(automatic)'
		'Gui.ChunkColumnTip'        = 'Leave empty for automatic detection. A fixed column can only be given when exactly one table is selected - with several, each table is detected on its own.'
		'Gui.DetectChunkColumn'     = 'Detect'
		'Gui.DetectRunning'         = 'Detecting chunk column...'
		'Gui.DetectResult'          = 'Chunk column for {0}: [{1}], {2} chunk(s), about {3} row(s) per chunk (estimated from statistics, no scan).'
		'Gui.DetectNone'            = 'No suitable chunk column found for {0}: {1}'
		'Gui.DetectFailed'          = "Chunk column detection failed:`n{0}"
		'Gui.DetectSelectOneTable'  = 'Please select exactly one table to detect its chunk column.'
		'Gui.ChunkRunning'          = 'Chunked transfer running: {0} ({1} of {2})...'
		'Gui.ChunkTableFailed'      = 'Chunked transfer failed for {0}: {1}'
		'Gui.AutoModeDecision'      = 'Automatic: {0} table(s) chunked, {1} table(s) plain.'
